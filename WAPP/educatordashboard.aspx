...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <style>
        ...
        .welcome { color: #111827; font-size: 24px; font-weight: 700; margin-bottom: 8px; }
        .sub { color:#6b7280; margin-bottom: 22px; }

        .stats { display:flex; gap:18px; flex-wrap:wrap; margin-bottom: 30px; }
        .card {
        ...
        .card h3 { color:#001eff; margin:0; font-size:14px; font-weight:700; }
        .stat-value { font-size:20px; font-weight:700; color:#111827; }

        /* Courses */
        .section { margin-top: 28px; }
        .section .heading-row { display:flex; justify-content:space-between; align-items:center; margin-bottom:12px; }
        .create-btn { background:#001eff; color:white; border-radius:8px; padding:8px 14px; text-decoration:none; font-weight:600; display:inline-block; }
        ...
        .course-title { font-size:16px; font-weight:700; color:#111827; margin-bottom:8px; }
        .badge-free {
            background:#eef6ff; color:#0b57ff; border-radius:12px; padding:4px 8px; font-size:12px; font-weight:600;
        }
        .course-meta { color:#6b7280; font-size:13px; margin-bottom:8px; }

        .course-actions { display:flex; gap:10px; margin-top:10px; }
        .btn {
        ...
        .quick-actions { margin-top: 18px; display:grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap:16px; }
        .action-card {
        ...
        .action-card:hover { transform: translateY(-4px); box-shadow:0 6px 18px rgba(0,0,0,0.06); }
        .action-title { font-size:15px; font-weight:700; color:#111827; margin-bottom:6px; }
    ...
    <div class="dashboard-container">
            ...
            <div class="card">
                <div class="card-left">
                    <div>
                        ...
                        <div class="stat-value"><asp:Label ID="lblCoursesCreated" runat="server" Text="0" /></div>
                    </div>
                </div>
                <div>
            ...
            <div class="card">
                <div class="card-left">
                    <div>
                        ...
                        <div class="stat-value"><asp:Label ID="lblCourseCompletions" runat="server" Text="0" /></div>
                    </div>
                </div>
                <div>
        ...
        <div class="section">
            ...
            <div class="quick-actions">
                ...
                <asp:HyperLink ID="hlAnalytics" runat="server" NavigateUrl="~/Analytics.aspx" CssClass="action-card">
                    <div class="action-title">Analytics</div>
                    <div class="action-desc">Track course performance</div>
                </asp:HyperLink>
            </div>
        </div>
    </div>
